...
public class nominatePlayerLogic : MonoBehaviour
{
    ...
    [SerializeField] public ChapterLogicBase cl;

    public void Start()
    {
        clearUnusedObjects();
        nominatePlayerOptions();
    }
    ...
    public void nominatePlayerOptions()
    {
        ...
        switch (playersCount)
        {
            case 2:
                ...
                nominateIndividualOption(Instantiate(MainManager.Instance.Players[0].hud, player1.transform), MainManager.Instance.Players[0]);

                player2.SetActive(true);
                nominateIndividualOption(Instantiate(MainManager.Instance.Players[1].hud, player2.transform), MainManager.Instance.Players[1]);
            ...
            case 3:
                ...
                nominateIndividualOption(Instantiate(MainManager.Instance.Players[2].hud, player3.transform), MainManager.Instance.Players[2]);
            ...
            case 4:
                ...
                nominateIndividualOption(Instantiate(MainManager.Instance.Players[3].hud, player4.transform), MainManager.Instance.Players[3]);
    ...
    public void nominateIndividualOption(GameObject hudItem, PlayerBase player)
    {
        //resize box itself       
        ...
        hudItem.GetComponent<Button>().onClick.AddListener(() => player.setNominatedPlayer(continueButton));
